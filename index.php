...
<head>
  ...
  <link rel="stylesheet" href="assets/vendor/css/pages/contacts.css">
    <!-- Libs -->
...
<body>
  ...
  <div class="layout-wrapper layout-2">
    <div class="layout-inner">
      ...
      <div id="layout-sidenav" class="layout-sidenav sidenav sidenav-vertical bg-dark">
        ...
        <!-- Links -->
        <!-- Links -->
        <ul class="sidenav-inner py-1" id="renderMenu">
      ...
      <div class="layout-container">
        ...
        <div class="layout-content">
          ...
          <!-- Content -->
          <div class="container-fluid flex-grow-1 container-p-y" id="app-root">
  ...
  <script src="assets/vendor/js/sidenav.js"></script>
	...
	<script src="assets/js/pages_projects_item.js"></script>
...
<script src="https://code.jquery.com/ui/1.13.1/jquery-ui.js"></script>
  ...
  <script src="assets/vendor/libs/jstree/jstree.js"></script>
    <script src="assets/js/pages_contacts.js"></script>
